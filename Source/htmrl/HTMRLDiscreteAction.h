	...
	public:
		struct RegionDesc {
			...
			RegionDesc()
				...
				_columnSize(4),
				_connectionRadius(4),
				_initInhibitionRadius(4.0f),
				_initNumSegments(0),
				_permanenceDistanceBias(0.1f),
				_permanenceDistanceFalloff(2.0f),
				_permanenceBiasFloor(-0.05f),
				_connectionPermanenceTarget(0.301f),
				_connectionPermanenceStdDev(0.04f),
				_minPermanence(0.3f),
				_minOverlap(1.0f),
				_desiredLocalActivity(18),
				_spatialPermanenceIncrease(0.02f),
				_spatialPermanenceDecrease(0.015f),
				_minDutyCycleRatio(0.01f),
				_activeDutyCycleDecay(0.03f),
				_overlapDutyCycleDecay(0.03f),
				_subOverlapPermanenceIncrease(0.013f),
				...
				_temporalPermanenceIncrease(0.017f),
				_temporalPermanenceDecrease(0.013f),
