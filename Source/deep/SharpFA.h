...
namespace deep {
	...
	public:
		...
		void createFromParents(const SharpFA &parent1, const SharpFA &parent2, float averageChance, std::mt19937 &generator);
		...
		void process(const std::vector<float> &inputs, std::vector<float> &outputs, float sharpness, int numSharpen);
