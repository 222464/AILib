...
int main() {
	...
	/*layerDescs[2]._rbfWidth = 16;
	layerDescs[2]._rbfHeight = 16;
	layerDescs[2]._receptiveRadius = 6;
	layerDescs[2]._inhibitionRadius = 3;
	layerDescs[2]._localActivity = 8.0f;
	layerDescs[2]._outputIntensity = 0.5f;
	layerDescs[2]._outputMultiplier = 1.0f;*/
	...
	layerDescs[2]._outputMultiplier = 1.0f;
	layerDescs[2]._localActivity = 4.0f;
	layerDescs[2]._outputIntensity = 0.6f;*/
